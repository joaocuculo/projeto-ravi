    ...
    <main>
        <div class="banner">
            ...
            <section>
                ...
                <h1>um jeito novo!</h1>
                <a href="cadastrar.php"><button class="cad-btn">Vem participar</button></a>
            </section>
        </div>
        <div class="estude-casa">
            ...
            <section>
                ...
                <a href="cadastrar.php"><button class="cad-btn2">Comece a aprender</button></a>
            </section>
        </div>
        <div class="cursos">
            <div class="escolha">
